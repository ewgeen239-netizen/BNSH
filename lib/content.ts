...
export const works: Work[] = [
  ...
  },
  {
    ...
    year: '2025',
    description:
      'Многостраничный сайт медицинского центра: услуги, врачи, запись. Спокойный премиальный тон и понятная навигация.',
    stack: ['Next.js', 'Tailwind', 'CMS'],
    accent: ['#1b2a4a', '#5B8DEF'],
  },
  {
    slug: 'lumen-coaching',
    title: 'Lumen Coaching',
    type: 'Лендинг под заявки',
    category: 'landing',
    year: '2025',
    description:
      'Продающий лендинг для эксперта: сильная структура, кейсы, форма записи на консультацию с высокой конверсией.',
    stack: ['Next.js', 'Framer Motion'],
    accent: ['#3a2a12', '#C6A15B'],
  },
  {
    slug: 'vela-finance',
    title: 'Vela Finance',
